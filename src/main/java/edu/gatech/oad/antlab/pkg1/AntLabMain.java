 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Nikhil Ramanan");
		  toPrint += p1.toString("nramanan6");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jianing Yang");
		  toPrint += p2.toString("903143874");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Jingtian Zhang");
		  toPrint += p3.toString("jzhang729");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Jonathan Zhang");
                  toPrint += p4.toString("jzhang760");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Jason Wu");
                  toPrint += p5.toString("jwu377");
